...
<div class="content-header">
	<div class="leftside-content-header">
	    <ul class="breadcrumbs">
	        ...
	        <li><a href="{{ route('news.index') }}"> News Lists</a></li>
	    </ul>
	</div>
</div>
@stop
...
<div class="row">
	<div class="col-sm-12">
		...
		<span class="pull-right">
			<a href="{{ route('news.create')}}" class="btn btn-success btn-right-side"><i class="fa fa-plus"></i></a>
		</span>
		 <div class="panel">
                        ...
                        <tbody>
                        	...
                        	<tr>
                              ...
                              {{--   <td> {{ $data->user->name }} </td> --}}
                                <td> 
                                <a class="btn btn-transparent" title="" data-original-title="Edit" href="{{ route('news.edit',$data->id) }}"><i class="fa fa-pencil"></i></a>
