...
<div class="content-header">
	<div class="leftside-content-header">
	    <ul class="breadcrumbs">
	        ...
	        <li><a href="{{ route('pips.index') }}"> pips Lists</a></li>
	    </ul>
	</div>
</div>
@stop
...
<div class="row">
	<div class="col-sm-12">
		...
		<span class="pull-right">
			<a href="{{ route('pips.create')}}" class="btn btn-success btn-right-side"><i class="fa fa-plus"></i></a>
		</span>
		 <div class="panel">
            <div class="panel-content">
				 <div class="table-responsive">
                    <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            @php $i=1; @endphp
                            @foreach ($pips as $data)
                        	<tr>
                                <td> {{ $i }} </td>
                                <td> {{ str_limit($data->month_year, 35) }} </td>
                                <td> {{ str_limit($data->month_year, 35) }} </td>
                                <td> 
                                <a class="btn btn-transparent" title="" data-original-title="Edit" href="{{ route('pips.edit',$data->id) }}"><i class="fa fa-pencil"></i></a>
                                 {!! Form::open(['method' => 'DELETE','route' => ['pips.destroy', $data->id],'style'=>'display:inline']) !!}
