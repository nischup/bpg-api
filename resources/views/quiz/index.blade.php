...
<div class="content-header">
	<div class="leftside-content-header">
	    <ul class="breadcrumbs">
	        ...
	        <li><a href="{{ route('quiz.index') }}"> Quiz Topic Lists</a></li>
	    </ul>
	</div>
</div>
@stop
...
<div class="row">
	<div class="col-sm-12">
		<h4 class="section-subtitle">
			<b> Quiz Topic Lists </b>
		</h4>
		<span class="pull-right">
			<a href="{{ route('quiz.create')}}" class="btn btn-success btn-right-side"><i class="fa fa-plus"></i></a>
		</span>
		 <div class="panel">
				 ...
				 <div class="table-responsive">
                    <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                        ...
                        <tbody>
                        	...
                        	<tr>
                                <td> {{ $i }} </td>
                                <td> {{ str_limit($data->quiz_title, 35) }} </td>
                                <td>  {{ str_limit($data->quiz_topic, 70) }} </td>
                            	<td> <img src="{{ $data->image }}" alt="No Image" width="50" height="50"> </td>
                                <td> {{ $data->status == "1" ? "Active" : "In-Active" }} </td>
                                <td> 
                                <a class="btn btn-transparent" title="" data-original-title="Edit" href="{{ route('quiz.edit',$data->id) }}"><i class="fa fa-pencil"></i></a>
